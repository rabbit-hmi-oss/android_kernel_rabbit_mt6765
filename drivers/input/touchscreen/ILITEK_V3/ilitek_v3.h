...
#define DRIVER_VERSION			"3.0.7.0.210625"
...
//Antai <AI_BSP_TP> <hehl> <2021-08-05> upgrade fw begin
#define BOOT_FW_UPDATE			ENABLE
//Antai <AI_BSP_TP> <hehl> <2021-08-05> upgrade fw end
...
({									\
	printk("ILITEK: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\
