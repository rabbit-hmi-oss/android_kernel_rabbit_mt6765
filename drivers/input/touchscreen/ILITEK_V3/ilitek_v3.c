...
#ifdef CONFIG_AI_BSP_CTP_FACTORYTOOL_SUPPORT
	while(atomic_read(&ilits->fw_stat))
	{	
...
//Antai <AI_BSP_TP> <yaoyc> <2022-03-02> disable avdd avee begin
			//PMU_db_pos_neg_disable_delay(15);
			mdelay(15);
//Antai <AI_BSP_TP> <yaoyc> <2022-03-02> disable avdd avee end
		}
