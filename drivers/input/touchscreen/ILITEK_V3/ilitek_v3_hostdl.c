...
extern int ai_set_device_info(struct ai_device_info gn_dev_info);
#endif
...
//Antai <AI_BSP_TP> <hehl> <2021-08-09> copy 1900 tp code begin
#ifdef CONFIG_AI_BSP_MTK_DEVICE_CHECK
		snprintf(ai_tp_hw_info.name, AI_DEVICE_NAME_LEN, "ili%x_truly-FW[0x%x]",(ilits->chip->pid >> 8),tfd.new_fw_cb);
