...
static struct LCM_setting_table init_setting_vdo[] = 
{
	...
	{0xC0, 0x02, {0x4F, 0x00}},
	{0xC1, 0x02, {0x10, 0x0C}},
	{0xC2, 0x02, {0x07, 0x14}},         //0x00：1dot 0x01：2dot
	{0xCC, 0x01, {0x10}},
	{0xB0, 0x10, {0x0A, 0x18, 0x1E, 0x12, 0x16, 0x0C, 0x0E, 0x0D, 0x0C, 0x29, 0x06, 0x14, 0x13, 0x29, 0x33, 0x1C}},
	{0xB1, 0x10, {0x0A, 0x19, 0x21, 0x0A, 0x0C, 0x00, 0x0C, 0x03, 0x03, 0x23, 0x01, 0x0E, 0x0C, 0x27, 0x2B, 0x1C}},
	{0xE5, 0x01, {0x00}},
	...
	{0xE1, 0x0B, {0x06, 0xA0, 0x08, 0xA0, 0x05, 0xA0, 0x07, 0xA0, 0x00, 0x44, 0x44}},
	{0xE2, 0x0C, {0x20, 0x20, 0x44, 0x44, 0x96, 0xA0, 0x00, 0x00, 0x96, 0xA0, 0x00, 0x00}},
	{0xE3, 0x04, {0x00, 0x00, 0x22, 0x22}},
	{0xE4, 0x02, {0x44, 0x44}},
	{0xE5, 0x10, {0x0D, 0x91, 0x0A, 0xA0, 0x0F, 0x93, 0x0A, 0xA0, 0x09, 0x8D, 0x0A, 0xA0, 0x0B, 0x8F, 0x0A, 0xA0}},
	{0xE6, 0x04, {0x00, 0x00, 0x22, 0x22}},
	{0xE7, 0x02, {0x44, 0x44}},
	{0xE8, 0x10, {0x0C, 0x90, 0x0A, 0xA0, 0x0E, 0x92, 0x0A, 0xA0, 0x08, 0x8C, 0x0A, 0xA0, 0x0A, 0x8E, 0x0A, 0xA0}},
	{0xE9, 0x02, {0x36, 0x00}},
...
static int lcm_set_display_on(void)
{
	...
	push_table(NULL, set_display_on, sizeof(set_display_on) / sizeof(struct LCM_setting_table), 1);
...
#ifdef BUILD_LK
    DISPDBG("%s, LK   ili9883_boe debug:  ili9883_boe id = 0x%08x buffer[0]=0x%08x,buffer[1]=0x%08x, id=0x%x\n", __func__, id,buffer[0],buffer[1],id);
#else
    printk("%s, LK   ili9883_boe debug:  ili9883_boe id = 0x%08x buffer[0]=0x%08x,buffer[1]=0x%08x \n", __func__, id,buffer[0],buffer[1]);
#endif	

	return 1;
}

struct LCM_DRIVER ili9883_boe_mipi_hd_lcm_drv = {
	.name = "ili9883_boe_mipi_hd_lcm_drv",
