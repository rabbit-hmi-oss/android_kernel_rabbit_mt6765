...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.checksum_value = 0xdf4593fd,//0x46e19e18, mirror+flip
	.pre = {
		.pclk = 288000000,
		.linelength = 3800,
		.framelength = 2526,
...
static void sensor_init(void)
{
	...
	//write_cmos_sensor(0x0006, 0x09BC); //old
	write_cmos_sensor(0x0006, 0x09DE); //new
	...
	//write_cmos_sensor(0x0074, 0x09B6); //old
	write_cmos_sensor(0x0074, 0x09D8); //new 
