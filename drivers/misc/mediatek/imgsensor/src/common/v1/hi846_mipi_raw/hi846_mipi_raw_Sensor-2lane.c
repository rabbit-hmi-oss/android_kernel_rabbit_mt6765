...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.linelength = 7600,				//record different mode's linelength
		.framelength = 1263,			//record different mode's framelength
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0008, 0x1DB0);
	...
	write_cmos_sensor(0x0128, 0x0014);
	write_cmos_sensor(0x012A, 0xFFFF);
	write_cmos_sensor(0x0120, 0x0026);
	write_cmos_sensor(0x0122, 0x0356);
	write_cmos_sensor(0x012C, 0x0010);
	write_cmos_sensor(0x012E, 0xFFFF);
	write_cmos_sensor(0x0124, 0x0020);
	write_cmos_sensor(0x0126, 0x0358);
	...
	write_cmos_sensor(0x0916, 0x0517);
	write_cmos_sensor(0x0918, 0x0206);
	write_cmos_sensor(0x091A, 0x0A07);
	write_cmos_sensor(0x091C, 0x0D07);
	write_cmos_sensor(0x091E, 0x0B00);
	write_cmos_sensor(0x090C, 0x08DC);
	write_cmos_sensor(0x090E, 0x0118);
	...
	write_cmos_sensor(0x0F2A, 0x412C);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0918, 0x0204);
	write_cmos_sensor(0x091A, 0x0507);
	write_cmos_sensor(0x091C, 0x0B04);
	write_cmos_sensor(0x091E, 0x0600);
	write_cmos_sensor(0x090C, 0x045E);
	write_cmos_sensor(0x090E, 0x0080);
	write_cmos_sensor(0x0954, 0x0089);
	write_cmos_sensor(0x0956, 0x0000);
	write_cmos_sensor(0x0958, 0xCA80);
	write_cmos_sensor(0x095A, 0x9240);
	write_cmos_sensor(0x0F32, 0x025A);
	write_cmos_sensor(0x0F38, 0x025A);
	write_cmos_sensor(0x0F2A, 0x492C);
	write_cmos_sensor(0x004C, 0x0100);
	//write_cmos_sensor(0x0A00, 0x0100);
}
